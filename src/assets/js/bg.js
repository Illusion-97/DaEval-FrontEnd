...
$('body').on('click', function (e) {
  if (c.getAttribute('stopped')) return
  ...
  var gridX = Math.floor((xMousePos - (xMousePos / c.width * 2 - 1) * 20 - xMousePos / c.width * 75) / c.width * cw);
  var gridY = Math.floor((yMousePos - (yMousePos / c.height * 2 - 1) * 75 + 40) / c.height * ch);
